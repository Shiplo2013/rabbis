...
export default function SingleRabbis(props: ChildProps) {
  return (
    ...
    >
      <div className="rabbis-image w-full h-auto sm:h-86 mb-3 sm:mb-8.5 relative overflow-hidden">
        <Image
      ...
      <div className="rabbis-text text-[20px] sm:text-[28px] text-(--theme-color) leading-[0.9em]">
