              ...
              {links.map((link, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    {haveSubmenu && (
                      <div className="submenu-content absolute bottom-full -mb-21.5 pr-10 transition-all duration-500 min-w-48 rotate-90 opacity-0 -translate-x-full invisible origin-topcenter group-hover/parent:opacity-100 group-hover/parent:visible group-hover/parent:translate-x-0">
