...
export default function ZatzelPostCat(props: ChildProps) {
  ...
  return (
    <section
      ...
      className={`zatzel-cat-section ${props.className} will-change-transform w-full`}
    >
      ...
      <div className="posts-wrapper w-full h-auto flex lg:gap-10 gap-[5vw] flex-col sm:flex-row flex-wrap lg:flex-nowrap">
