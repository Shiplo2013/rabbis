...
export default function SingleZatzelGraduate(props: ChildProps) {
  ...
  return (
    ...
    >
      <div className="post-image w-full h-75 sm:h-60 lg:h-101.5 mb-8.5 relative overflow-hidden backface-hidden">
        <Image
      ...
      <div className="post-text text-[20px] sm:text-[28px] text-(--theme-color) leading-[0.9em] text-right">
