  ...
  return (
    ...
    >
      <div className="rabbis-content-wrapper w-full h-auto flex items-center">
        <div className="rabbis-menu text-[55px] text-[#D1A941] leading-[70%] flex flex-col gap-y-[4vh] w-[25vw] min-w-[25vw] overflow-hidden">
          <div className="rabbis-menu-item flex items-center gap-x-[1.8vw] group cursor-pointer">
