...
export default function MainMenu({ active, hideMenu, timeLine }) {
    const SUBMENU = [
        {id: 1, title: "שם הרב"},
        {id: 2, title: "שם הרב"},
    ];
...
//    }
  return (
    <div 
    id="main-menu" 
    className={`fixed top-0 left-0 w-screen h-screen bg-[#000000] bg-no-repeat bg-cover z-50 flex items-center justify-center gap-10 opacity-0 invisible py-[5vh] px-[5vw]`}>
        <div
            style={{backgroundImage: `url(${bagImage.src})`}} 
            className="menu-background bg-cover absolute top-0 right-0 w-full h-full"></div>
        <button 
            onClick={() => {
                hideMenu(false);
                //closeMenu();
        ...
        <div className="menu-wrapper w-[80%] h-auto text-[#E2D7C3] text-[24px]">
            <div className="main-menu-top flex overflow-hidden">
            ...
            <div className="main-menu-bottom mt-17 flex items-end overflow-hidden">
